...
class App(Frame):
	...
	def initUI(self):
		...
		self.btnResolving = Button(self.frameWidget, text = "AND-OR graph search", command = self.resolving)
	...
	def resolving(self):
		...
		solution, ti = and_or.getResults(numOfQueens)
